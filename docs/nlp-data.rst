...
.. note::
  ...
  ``lambeq`` simplifies this process by providing the :py:class:`~.UnknownWordsRewriteRule` which can be used to replace unknown words, and create a vocabulary from a set of diagrams. Details can be found in :ref:`this example notebook </examples/unk_words.ipynb>`.
...
- :ref:`Handling unknown words example notebook </examples/unk_words.ipynb>`
